...
SERVER = "192.168.29.141"  #We enter the server's IP address here
PORT = 9999
ADDRESS = (SERVER, PORT)
...
bkg = pygame.image.load("./dino/bg.jpg")
...
menu_icon = pygame.image.load("./dino/menu.jpg")
clock = pygame.time.Clock()

main = True
menu = True
waiting_for_player = True
font_of_start_game = pygame.font.SysFont("times new roman", 50, True)
font_of_quit_game = pygame.font.SysFont("times new roman", 50, True)
font_of_waiting_for_player = pygame.font.SysFont("times new roman", 100, True)
